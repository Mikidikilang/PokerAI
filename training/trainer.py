...
class PPOTrainer:
    ...
    ENTROPY_COEF=0.01; ENTROPY_FINAL=0.001; ENTROPY_DECAY=30_000_000
    ...
    def __init__(self, model, lr=3e-4, device=None):
        ...
        self.scheduler=optim.lr_scheduler.StepLR(self.optimizer,step_size=1_000_000,gamma=0.7)
    ...
    def load_state_dict(self, d):
        if 'optimizer' in d: self.optimizer.load_state_dict(d['optimizer'])
        if 'scheduler' in d: self.scheduler.load_state_dict(d['scheduler'])
